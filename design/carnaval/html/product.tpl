...
{if !empty($related_products)}
	...
	<div id="hitcarusel" class="tiny_products hoverable owl-carousel" style="margin-bottom: 20px;">
...
{*	{get_products var=featured_products featured=1 category_id=$category->id sort=rand limit=10}*}
	{get_products var=featured_products featured=0 sort=rand limit=10}
{else}
	{get_products var=featured_products featured=1 sort=rand limit=10}
{/if}
{if !empty($featured_products)}
	...
	<div id="hitcontent" class="tiny_products hoverable owl-carousel" style="margin-bottom: 20px;">
