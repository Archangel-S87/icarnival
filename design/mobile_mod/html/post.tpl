...
<div id="back_forward">
	{if $prev_post}
		<span class="prev_page_link"><a class="next_page_link" href="blog/{$prev_post->url}" title="{$prev_post->name}"><img src="/design/mobile/images/dark_prev.gif" alt="Пред." class="v-middle"/></a> <a class="prev_page_link" href="blog/{$prev_post->url}" title="{$prev_post->name}">{$prev_post->name|escape|truncate:35:"...":true}</a></span>
	{/if}
	{if $next_post}
		<span class="next_page_link"><a class="next_page_link" href="blog/{$next_post->url}" title="{$next_post->name}">{$next_post->name|escape|truncate:35:"...":true}</a> <a class="next_page_link" href="blog/{$next_post->url}" title="{$next_post->name}"><img src="/design/mobile/images/dark_next.gif" alt="След." class="v-middle"/></a></span>
	{/if}
</div>
