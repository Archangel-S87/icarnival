...
<head>
	...
	<link rel="stylesheet" type="text/css" href="design/mobile_mod/css/style.css?v={filemtime('design/mobile/css/style.css')}"/>
	{if $module == 'SurveysView'}
		<link rel="stylesheet" type="text/css" href="design/mobile_mod/css/survey.css?v={filemtime("design/mobile/css/survey.css")}"/>
	{/if}
...
<body id="body" class="{$module|lower}{if in_array($module, array('MainView', 'ProductsView', 'WishlistView')) || (!empty($page->url) && $page->url == 'catalog')} nonwhitebg{/if}">
	...
	<script type="text/javascript" src="design/mobile_mod/js/core.js?v={filemtime('design/mobile/js/core.js')}"></script>
	<script>
		$(function() {
			$('.zoom').fancybox({
				arrows: false,
				...
				infobar: false,
				buttons: ['close'],
				baseClass: 'fancybox-custom-image-container',
				beforeShow: function () {
	...
	{if $module == 'ProductsView'}
		<script src="design/mobile_mod/js/priceslider.js" type="text/javascript"></script>
	...
	{if in_array($module, array('ProductsView', 'ArticlesView', 'BlogView', 'SurveysView')) && !empty($total_pages_num) && $total_pages_num > 1 }
		{* infinite ajax pagination *}
			...
			<script type="text/javascript" src="js/mobile_mod/infinite_ajax.js"></script>
		{* infinite ajax pagination end *}
	{/if}
	
	{if $module == 'ProductView'}
		<script type="text/javascript" src="design/mobile_mod/js/product.js"></script>
		<script>
		// Amount change
		$(window).load(function() {
