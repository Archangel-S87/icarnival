...
class Managers extends Fivecms
{	
	public $permissions_list = array('slides', 'products', 'categories', 'brands', 'features', 'orders', 'labels',
		'users', 'groups', 'coupons', 'pages', 'blog', 'articles_categories', 'articles', 'comments', 'feedbacks', 'import', 'export', 'backup', 'stats', 'design', 'settings', 'currency', 'delivery', 'payment', 'managers', 'discountgroup', 'multichanges', 'license', 'menus', 'services_categories', 'surveys_categories', 'surveys', 'trigger', 'promo', 'banners', 'mailer', 'maillist', 'mailuser');
		
	public $passwd_file = "fivecms/.passwd";
