...
class Money extends Fivecms
{
	...
	public function __construct()
	{
		...
		$this->design->smarty->registerPlugin('modifier', 'noformat', array($this, 'noFormat'));
	...
	private function init_currencies()
	{
		...
		$query = "SELECT * FROM __currencies ORDER BY position";
		$this->db->query($query);
	...
	public function noFormat($price, $convert_type = null, $currency_id = null)
	{
		if(isset($currency_id))
		{
			if(is_numeric($currency_id))
