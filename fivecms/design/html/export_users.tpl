...
{capture name=tabs}
	...
	<li class="active"><a href="index.php?module=ExportUsersAdmin">{$tr->buyers_export|escape}</a></li>
		...
		function do_export(page)
		{
			...
			$.ajax({
					...
					{	
						...
						window.location.href = '/fivecms/files/export_users/users.csv';
