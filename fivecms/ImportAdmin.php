...
class ImportAdmin extends Fivecms
{	
	public $import_files_dir = 'fivecms/files/import/';
	...
	public function fetch()
	{
        ...
        {
        	$this->settings->update_products = $this->request->post('update_products');
        	$this->settings->update_only = $this->request->post('update_only');
        	$this->settings->import_price = $this->request->post('import_price');
            $this->settings->d_name = $this->request->post('d_name');
			$this->settings->d_category = $this->request->post('d_category');
			$this->settings->category_delimiter = $this->request->post('category_delimiter');
			$this->settings->subcategory_delimiter = $this->request->post('subcategory_delimiter');
			$this->settings->d_brand = $this->request->post('d_brand');
			$this->settings->d_variant = $this->request->post('d_variant');
			$this->settings->d_variant1 = $this->request->post('d_variant1');
			$this->settings->d_variant2 = $this->request->post('d_variant2');
			$this->settings->d_price = $this->request->post('d_price');
			$this->settings->d_sku = $this->request->post('d_sku');
			$this->settings->d_stock = $this->request->post('d_stock');
			$this->settings->d_unit = $this->request->post('d_unit');
			$this->settings->d_currency_id = $this->request->post('d_currency_id');
			$this->settings->d_meta_title = $this->request->post('d_meta_title');
			$this->settings->d_meta_description = $this->request->post('d_meta_description');
