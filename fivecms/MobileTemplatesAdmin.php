...
class MobileTemplatesAdmin extends Fivecms
{	
	public function fetch()
	{
		$templates_dir = 'design/mobile/html/';
		$templates = array();
		...
		else
		{
			...
			$_SESSION['last_edited_mobtemplate'] = $template_file;		
		}
		
		$this->design->assign('theme', 'mobile');
		$this->design->assign('templates', $templates);
  	  	return $this->design->fetch('mobile_templates.tpl');
	}
